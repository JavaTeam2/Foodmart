...
<body>
	...
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/admin/categories/delete-categories"
			method="POST">
					...
					<tbody>
						<c:forEach items="${categories}" var="categories">
							<tr>
								...
								<td><a
									href="${pageContext.request.contextPath}/admin/edit-categories/${categories.id}"
									class="btn btn-primary btn-sm"> <span
										class="glyphicon glyphicon-edit"></span>
								</a></td>
								
								<td><a
									href="${pageContext.request.contextPath}/admin/categories/delete-categories/${categories.id}"
