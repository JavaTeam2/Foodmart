                    ...
                    <div class="product-content-right">
                        ...
                        <label class="checkbox" for="ship-to-different-address-checkbox">Ship to address?</label>
                                            ...
                                            <div class="shipping_address" style="display: block;">
												...
												<c:forEach items="${cartForm_list }" var = "cartLine" varStatus="i">
													<input type="hidden" path="listUserDetails[${i.index}].id"/>
                                                    <input type="hidden" name="orderdetails" value="${cartLine.order_id.id}"/>
                                                    <input type="hidden" name="orderdetails" value="${cartLine.food_id.id}"/>
                                                    <input type="hidden" name="orderdetails" value="${cartLine.price}"/>
                                                    <input type="hidden" name="orderdetails" value="${cartLine.id}"/>
												</c:forEach>
