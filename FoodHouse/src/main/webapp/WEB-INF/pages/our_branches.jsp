					...
					<div class="navbar-top">
							...
							<li><a href="home" data-hover="Home">Home</a> </li>
								...
								<li><a href="gallery"  data-hover="Gallery">Gallery</a></li>
							  	<li class="active"><a href="our_branches" data-hover="OurBranches">Our Branches</a></li>
	...
	<div class="container" style="padding:2em 0;">
		<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#learning" role="tab" id="learning-tab" data-toggle="tab" aria-controls="learning">TP. HCM</a></li>
					<li role="presentation"><a href="#playing" role="tab" id="playing-tab" data-toggle="tab" aria-controls="playing">Ha Noi</a></li>
					<li role="presentation"><a href="#painting" role="tab" id="painting-tab" data-toggle="tab" aria-controls="painting">Da Nang</a></li>
					<li role="presentation"><a href="#school" role="tab" id="school-tab" data-toggle="tab" aria-controls="school">Nha Trang</a></li>
				</ul>
				<div id="myTabContent" class="tab-content">
						...
						<div class="w3_tab_img">
							<c:forEach items="${listBranches }" var="branch">
								<div class="col-sm-3 w3_tab_img_left">
									<div class="demo">
										<a class="cm-overlay" href="${branch.image }">
										  <figure class="imghvr-shutter-in-out-diag-2"><img src="${branch.image }" alt=" " class="img-responsive" />
										  </figure>
										</a>
									</div>
									<div class="agile-gallery-info">
											<h5>${branch.name }</h5>
											<p>${branch.address } - ${branch.province }</p>
									</div>
								</div>
							</c:forEach>
							<div class="clearfix"> </div>
					...
					<div role="tabpanel" class="tab-pane fade" id="learning" aria-labelledby="learning-tab">
						<div class="w3_tab_img">
							<c:forEach items="${listHCM }" var="branch">
								<div class="col-sm-3 w3_tab_img_left">
									<div class="demo">
										<a class="cm-overlay" href="${branch.image }">
											<figure class="imghvr-shutter-in-out-diag-2"><img src="${branch.image }" alt=" " class="img-responsive">
					...
					<div role="tabpanel" class="tab-pane fade" id="playing" aria-labelledby="playing-tab">
						<div class="w3_tab_img">
							<c:forEach items="${listHANOI }" var="branch">
								<div class="col-sm-3 w3_tab_img_left">
									<div class="demo">
										<a class="cm-overlay" href="${branch.image }">
											<figure class="imghvr-shutter-in-out-diag-2"><img src="${branch.image }" alt=" " class="img-responsive">
					...
					<div role="tabpanel" class="tab-pane fade" id="painting" aria-labelledby="painting-tab">
						<div class="w3_tab_img">
							<c:forEach items="${listDANANG }" var="branch">
								<div class="col-sm-3 w3_tab_img_left">
									<div class="demo">
										<a class="cm-overlay" href="${branch.image }">
											<figure class="imghvr-shutter-in-out-diag-2"><img src="${branch.image }" alt=" " class="img-responsive">
					...
					<div role="tabpanel" class="tab-pane fade" id="school" aria-labelledby="school-tab">
						...
						<div class="w3_tab_img">
							<c:forEach items="${listNHATRANG }" var="branch">
								<div class="col-sm-3 w3_tab_img_left">
									<div class="demo">
										<a class="cm-overlay" href="${branch.image }">
											<figure class="imghvr-shutter-in-out-diag-2"><img src="${branch.image }" alt=" " class="img-responsive">
